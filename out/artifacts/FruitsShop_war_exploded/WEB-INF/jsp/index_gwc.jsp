...
<body>
	...
	<div class="m"><p class="m1">我的购物车</p></div>
	<div class="k">
		<div class="k1">
			...
			<c:forEach items="${orderFromList}" var="orderFrom">
				<tr>
					...
					<td class="k2"><a href="${pageContext.request.contextPath}/deleteOrder/${orderFrom.fruitsName}"><input class="k3" type="button" value="删除"></a></td>
				</tr>
			</c:forEach>
			</table>
		</div>
		<div style="width: 100px;height: 50px;margin: 0 auto;padding-top: 20px;">
			<a href="${pageContext.request.contextPath}/buyFruits"><input class="sh6" type="button" value="立即购买" /></a>
		</div>
	</div>
</body>
<script>
